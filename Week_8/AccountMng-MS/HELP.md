...
* The original package name 'com.week8.AccountMng-MS' is invalid and this project uses 'com.week8.AccountMng_MS' instead.
...
* [Spring for Apache ActiveMQ 5](https://docs.spring.io/spring-boot/4.0.4/reference/messaging/jms.html#messaging.jms.activemq)
